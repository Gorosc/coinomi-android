...
public class CompanyPayrollInfo extends BitwageBase {
    ...
    private List<CompanyPayrollSimple> companyPayrollList;

    public CompanyPayrollInfo(JSONObject data) throws ShapeShiftException {
        super(data);
        if (!isError) {
            try {
                ...
                companyPayrollList = new ArrayList<>();

                JSONArray payrollsarray = data.getJSONArray("payrolls");
                for (int i = 0; i < payrollsarray.length(); i++) {
                    companyPayrollList.add(new CompanyPayrollSimple(payrollsarray.getJSONObject(i)));
                }
    ...
    public List<CompanyPayrollSimple> getCompanyPayrollList() {
        return companyPayrollList;
    }

    public void setCompanyPayrollList(List<CompanyPayrollSimple> companyPayrollList) {
        this.companyPayrollList = companyPayrollList;
    }

    @Override
    public String toString() {
        return "CompanyPayrollInfo{" +
                ...
                ", meta=" + meta +
                ", companyPayrollList=" + companyPayrollList +
                '}';
    }
}
